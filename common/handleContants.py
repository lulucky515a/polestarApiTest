...
# testCasesSalary = os.path.join(testCasesDir, "02_salary")
# testCasesAIO = os.path.join(testCasesDir, "03_aio")
# testCasesTimeSheetList = os.path.join(testCasesDir, "04_timeSheetList")
# testCasesBpm = os.path.join(testCasesDir, "06_bpm")
# testCasesMasterData = os.path.join(testCasesDir, "07_masterData")
# testCasesFinancial = os.path.join(testCasesDir, "10_financial")